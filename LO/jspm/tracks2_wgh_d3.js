...
async function loadFiles() {
    ...
    let tracks = await d3.json("https://s3.kopah.uw.edu/liveocean-web/wgh0_tracks.json");
    let times = await d3.json("https://s3.kopah.uw.edu/liveocean-web/wgh0_times.json");
